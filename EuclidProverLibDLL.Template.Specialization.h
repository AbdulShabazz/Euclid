...
// Todo: convert to parameter-based hash map array 
__forceinline void Auto(
        Theorem_Struct InTheorem,
        const Axiom_Struct& InAxiom,
        const RouteSource_EnumClass& RouteSource_EnumClassParameter,
        const Indirection_EnumClass& Indirection_EnumClassParameter,
        ...
        const bool& InTotalProofsGEMaxAllowedProofs_ParameterFlag)
{
    ...
    switch (Indirection_EnumClassParameter)
    {
        case Indirection_EnumClass::_reduce:
            switch(RouteSource_EnumClass)
            {
                ...
                case RouteSource_EnumClass::_rhs:
                    ...
                    break;
                default:
                case RouteSource_EnumClass::_root:
                    switch (InTheorem.Indir_EnumClass)
                    {
                    case Indirection_EnumClass::_reduce:
                        std::for_each(std::execution::par_unseq,
